...
ENV CONFIG_JSON=none CERT_PEM=none KEY_PEM=none VER=v4.6.6

RUN apk add --no-cache --virtual .build-deps ca-certificates curl \
 && mkdir -m 777 /v2raybin \ 
 && cd /v2raybin \
 && curl -L -H "Cache-Control: no-cache" -o v2ray.zip https://github.com/v2ray/v2ray-core/releases/download/v4.6.6/v2ray-linux-64.zip \
 && unzip v2ray.zip \
